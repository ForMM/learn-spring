...
public class TestTengxun {
	...
	public static void testAccountRegister() throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
		...
		String httpUrl = "http://service-i7iwxtym-1255747603.gz.apigw.tencentcs.com/release/api/account_register.api";
		...
		bodyParams.put("msg_digest", "QzQ5Njg0MTIwRENCMTA4RUZGQTUxMkNGMjc4MkRDRTg4NzIzNDY5Nw==");
	...
	public static void testCompanyVerify() throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
		...
		// 签名
		String auth = calcAuthorization(source, secretId, secretKey, datetime);
		String httpUrl = "http://service-fq6jif1e-1255747603.gz.apigw.tencentcs.com/release/api/get_company_verify_url.api";
        ...
        Map<String, String> bodyParams = new HashMap<String, String>();
        bodyParams.put("app_id", "988888");
        bodyParams.put("msg_digest", "REYxOTc2OUQyM0MxQ0M2QzhFOEVBMDg3MDc2N0YzMDU1QjFBOEVENA==");
        bodyParams.put("v", "2.0");
        bodyParams.put("timestamp", "123123");
        ...
        bodyParams.put("customer_id", "B2F76DF20FB8CDBB313272FD0768B93E");
